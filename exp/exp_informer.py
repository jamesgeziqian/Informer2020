...
class Exp_Informer(Exp_Basic):
    ...
    def retrain(self, setting):
        """
        Feed validation and test data into the model, prepare for deployment.
        """
        train_data, train_loader = self._get_data(flag="retrain")
        ...
        for epoch in range(num_epochs):
            ...
            train_loss = np.average(train_loss)
            print(f"Epoch: {epoch + 1}, Steps: {train_steps} | Loss: {train_loss:.7f}")
